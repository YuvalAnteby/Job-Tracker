        ...
        <div className="space-y-8">
          ...
          {job.llm_summary && (
            <div className="space-y-2">
              ...
              <p className="text-gray-700 dark:text-slate-300 leading-relaxed italic bg-blue-50/50 dark:bg-blue-900/10 p-4 rounded-lg border border-blue-100 dark:border-blue-900/30">
                "{job.llm_summary}"
              </p>
            </div>
          )}
          ...
          <div className="space-y-4 p-6 bg-gray-50 dark:bg-slate-800/50 rounded-xl border border-gray-200 dark:border-slate-800">
            ...
            <div className="flex justify-end pt-2">
              <button
                ...
                className="flex items-center space-x-2 px-6 py-2 bg-gray-900 dark:bg-slate-700 hover:bg-black dark:hover:bg-slate-600 text-white text-sm font-bold rounded-lg transition-all shadow-md disabled:opacity-50"
              >
