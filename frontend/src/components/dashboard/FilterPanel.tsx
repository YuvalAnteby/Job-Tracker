...
export const FilterPanel: React.FC<FilterPanelProps> = ({ filters, setFilters }) => {
  ...
  return (
    <div className="py-4 space-y-10">
      <div>
        <h3 className="text-xs font-semibold text-gray-500 dark:text-slate-400 mb-4 uppercase tracking-wider">Search</h3>
      ...
      <div>
        <h3 className="text-xs font-semibold text-gray-500 dark:text-slate-400 mb-4 uppercase tracking-wider">Domain</h3>
      ...
      <div>
        <h3 className="text-xs font-semibold text-gray-500 dark:text-slate-400 mb-4 uppercase tracking-wider">Status</h3>
        <div className="flex flex-col gap-3">
      ...
      <div>
        <h3 className="text-xs font-semibold text-gray-500 dark:text-slate-400 mb-4 uppercase tracking-wider">Fit</h3>
        <select
