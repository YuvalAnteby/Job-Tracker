...
import { LayoutDashboard, ShieldAlert, Settings, PlusCircle, Briefcase } from 'lucide-react';
...
export const MainLayout: React.FC<MainLayoutProps> = ({ children }) => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-slate-950 flex flex-col">
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8 text-gray-900 dark:text-slate-200">
        {children}
      </main>
